        ...
        <div class="row pb-0 border-top pt-5 block__19738 section-counter">
          <div class="col-6 col-md-6 col-lg-3 mb-5 mb-lg-0">
            <div class="d-flex align-items-center justify-content-center mb-2">
              ...
              <strong class="number" data-number="2393">2,349</strong>
            </div>
          ...
          <div class="col-6 col-md-6 col-lg-3 mb-5 mb-lg-0">
            <div class="d-flex align-items-center justify-content-center mb-2">
              ...
              <strong class="number" data-number="54">53</strong>
            </div>
          ...
          <div class="col-6 col-md-6 col-lg-3 mb-5 mb-lg-0">
            <div class="d-flex align-items-center justify-content-center mb-2">
              ...
              <strong class="number" data-number="120">117</strong>
            </div>
          ...
          <div class="col-6 col-md-6 col-lg-3 mb-5 mb-lg-0">
            <div class="d-flex align-items-center justify-content-center mb-2">
              ...
              <strong class="number" data-number="550">539</strong>
            </div>
